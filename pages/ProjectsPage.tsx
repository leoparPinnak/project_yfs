...
const ProjectsPage: React.FC = () => {
  ...
  const slides = [
    ...
    { type: 'grouped', name: '2025 Turkcell Beyaz Konsept Bayi Dönüşüm Projesi', location: 'EGE BÖLGESİ', slug: 'turkcell', projects: turkcellProjects },
            ...
            >
              {isVideo ? (
                ...
                <div
                  ...
                  role="img"
                  aria-label={`${project.name} projesi, ${project.location}'da`}
                />
              )}
            </div>
          );
      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-between py-12 md:py-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center mt-4">
          <div key={currentIndex} style={{ animation: 'fadeIn 0.6s ease-out' }}>
            <h1 className="text-3xl md:text-5xl font-light tracking-wide mb-1 text-white/95 drop-shadow-lg leading-tight">
              {currentSlide.type === 'grouped' ? currentSlide.name : currentSlide.project!.name}
            </h1>
            <p className="text-sm md:text-base text-indigo-300 drop-shadow-md font-semibold tracking-widest uppercase mt-2">
              {currentSlide.type === 'grouped' ? currentSlide.location : currentSlide.project!.location}
            </p>
          </div>
        </div>
        ...
        <div className="flex-grow flex items-center justify-center my-6 overflow-hidden">
          {currentSlide.type === 'grouped' ? (
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row gap-4 min-h-[380px] lg:h-[420px] items-stretch">
                    ...
                    >
                      ...
                      <div className="absolute top-4 left-4 z-20">
                        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-950/80 backdrop-blur-md border border-emerald-500/30 shadow-[0_0_10px_rgba(16,185,129,0.15)]">
                          ...
                          <span className="text-[8px] tracking-wider uppercase text-emerald-300 font-semibold">Tamamlandı</span>
                        </div>
                      </div>
                      ...
                      <div className="relative z-10 text-left">
                        ...
                        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isActive ? 'max-h-24 opacity-100 mt-1 lg:mt-2' : 'lg:max-h-0 lg:opacity-0'}`}>
                          ...
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 text-xs text-emerald-400 hover:text-emerald-300 font-bold uppercase tracking-wider group/link transition-colors"
                          >
                            İncele
